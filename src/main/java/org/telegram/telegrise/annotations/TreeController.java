 ...
 * Tree contoller should have a constructor with no arguments.
 * <p>
 ...
 * </p><p>
 * In order to connect tree contoller to the tree transcription, it should have methods annotated by <a href="#{@link}">{@link org.telegram.telegrise.anntotations.Reference Reference}</a> annotation.
