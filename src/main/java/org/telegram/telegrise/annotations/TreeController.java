 ...
 * </p><p>
 * In order to connect tree controller to the tree transcription, it should have methods annotated by <a href="#{@link}">{@link org.telegram.telegrise.annotations.Reference Reference}</a> annotation.
